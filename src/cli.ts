...
program
  ...
  .option("-f, --format <type>", "output format (markdown, json, html)", "html")
  .option("-o, --output-dir <dir>", "output directory", "./public")
  .option("-m, --max-commits <number>", "maximum number of commits", "50")
  .option("-t, --include-tags", "include Git tags", false)
  .action(generate);
